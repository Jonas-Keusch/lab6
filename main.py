...
def print_linked_list(head):
    ...
    while current:  # Continue until we reach the end of the list (None)
        print(f"{current.data} -> ", end="")  # Print the data followed by "->"
...
print("Linked list after updating node2's data:")
print_linked_list(node1)
...
print("Linked list after adding node4:")
print_linked_list(node1)
...
def print_linked_list_with_count(head):
    ...
    while current:  # Traverse until the end of the list
        print(f"{current.data} -> ", end="")  # Print the data for each node
...
print("Final linked list with count:")
